...
- Links to overviews:
   ...
   - Implementation/tutorial: [ImageNet: VGGNet, ResNet, Inception, and Xception with Keras (keras)](https://www.pyimagesearch.com/2017/03/20/imagenet-vggnet-resnet-inception-xception-keras/)

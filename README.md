...
- Activation functions: Rectified Linear Unit (ReLU), Leaky version of a Rectified Linear Unit (LeakyReLU or LReLU), Parametrized or Parametric Rectified Linear Unit (PReLU), Exponential Linear Unit (ELU), Scaled Exponential Linear Unit (SELU), softplus, softsign, tanh, sigmoid, hard sigmoid, linear, logit, softmax, Swish. [wikipedia](https://en.wikipedia.org/wiki/Activation_function), [keras](https://keras.io/activations/), [keras (advanced)](https://keras.io/layers/advanced-activations/).

...
- Transfer learning.
- Max-pooling.
- Activation functions: softmax, exponential linear unit (elu), scaled exponential linear unit (selu), softplus, softsign, tanh, sigmoid, hard sigmoid, linear. ([keras-docs](https://keras.io/activations/))([wikipedia](https://en.wikipedia.org/wiki/Activation_function))

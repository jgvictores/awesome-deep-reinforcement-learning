...
- Regularization techniques (reduce overfitting): L2/L1/Maxnorm regularization, dropout, batch and weight normalization, data augmentation (image distortions, scale jittering...), early stopping, gradient checking.

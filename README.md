...
- Batch: REINFORCE, Truncated Natural Policy Gradient (TNPG), Trust Region Policy Optimization (TRPO), Relative Entropy Policy Search (REPS), Cross Entropy Method (CEM), A2C, ACER, ACKTR, DDPG, DQN, GAIL, HER, PPO1, PPO2.
